...
Θέτουμε ως όνομα "inactivityTimeout", είδος τιμής "Ακέραιος" και Ακέραια τιμή 120000, γιατί αναφερόμαστε σε χιλιοστοδευτερόλεπτα (το όριο που θέλουμε να θέσουμε είναι 2 λεπτά. Οπότε 2*60*1000=120000) (βλ Εικόνα Β12).
...
![Εικόνα Β6](./Εικόνες/Β1/5.%20Θερμόμετρο%20α'%20-4.jpg)
