...
Έπειτα συνδέουμε τον κόμβο "Input" με τον κόμβο-φίλτρο "Under Threshold".
...
![Εικόνα Β20](./Εικόνες/Β1/20.%20Προσθήκη%20κανόνα%20κόμβου%20create%20alarm%20β'.jpg)
...
**Β' Μηχανισμός Ειδοποίησης.**


Από την κεντρική καρτέλλα "Κανόνες", επιλέγουμε "Προσθήκη Αλυσίδας Κανόνων" -> "Δημιουργία Νέας Αλυσίδας Κανόνων". Στη συνέχεια δίνουμε ως όνομα το "Creation & Clearance of Alarms" και επιλέγουμε "Προσθήκη". Έπειτα, επιλέγουμε τον Κανόνα μας και "Open rule chain". Στη συνέχεια μεταφέρουμε ένα φίλτρο "script", το οποίο ονοματίζουμε "Anoikto Kapaki", κι επειδή θέλουμε να ειδοποιούμαστε όταν το είναι ανοικτό, θέτουμε ως script μας το "return msg.Opened ==true;" και πατάμε "Προσθήκη".


Έπειτα συνδέουμε τον κόμβο "Input" με τον κόμβο "Anoikto Kapaki".

Προσθέτουμε έναν κόμβο Κανόνα "create alarm", τον οποίο θα ονομάσουμε "Create Alarm", στο "Alarm type" θα θέσουμε "Critical Opening", θα επιλέξουμε "Propagate alarm to related entities" και έπειτα πατάμε "Προσθήκη". Στη συνέχεια, συνδέουμε τον κόμβο "Anoikto Kapaki" με τον "Create Alarm", με ετικέττα συνδέσμου "True" 


Τώρα θα προσθέσουμε έναν κόμβο τύπου "clear alarm", δίνουμε όνομα "Clear Alarm", "Alarm type" το "Critical Opening" και πατάμε "Προσθήκη".
Συνδέουμε τον κόμβο "Anoikto Kapaki" με αυτόν, με ετικέττα συνδέσμου "False".


Ανοίγουμε την Αλυσίδα Κανόνων της Ρίζας (Root Rule Chain), προσθέτουμε μία Αλυσίδα Κανόνων (rule chain), με όνομα "Creation & Clearance of Alarms", στην "Αλυσίδα Κανόνων" πληκτρολογούμε "Creation & Clearance of Alarms" και πατάμε "Προσθήκη". Συνδέουμε αυτή την Αλυσίδα Κανόνων με τον κόμβο "Save Time Series" με σύνδεσμο με ετικέττα "Success".



**Γ' Μηχανισμός Ειδοποίησης.**


Από την κεντρική καρτέλλα "Κανόνες", επιλέγουμε "Προσθήκη Αλυσίδας Κανόνων" -> "Δημιουργία Νέας Αλυσίδας Κανόνων". Στη συνέχεια δίνουμε ως όνομα το "Dimiourgia kai Ekka8arrisi Synagermwn" και επιλέγουμε "Προσθήκη". Έπειτα, επιλέγουμε τον Κανόνα μας και "Open rule chain". Στη συνέχεια μεταφέρουμε ένα φίλτρο "script", το οποίο ονοματίζουμε "Not Charged", κι επειδή θέλουμε να ειδοποιούμαστε όταν το ηλεκτροκίνητο όχημά μας χρειάζεται φόρτιση, θέτουμε ως script μας το "return msg.Charged <= 20;" και πατάμε "Προσθήκη".


Έπειτα συνδέουμε τον κόμβο "Input" με τον κόμβο "Not Charged".

Προσθέτουμε έναν κόμβο Κανόνα "create alarm", τον οποίο θα ονομάσουμε "Create Charging Alarm", στο "Alarm type" θα θέσουμε "Critical Charging", θα επιλέξουμε "Propagate alarm to related entities" και έπειτα πατάμε "Προσθήκη". Στη συνέχεια, συνδέουμε τον κόμβο "Not Charged" με τον "Create Charging Alarm", με ετικέττα συνδέσμου "True" 


Τώρα θα προσθέσουμε έναν κόμβο τύπου "clear alarm", δίνουμε όνομα "Clear Charging Alarm", "Alarm type" το "Critical Charging" και πατάμε "Προσθήκη".
Συνδέουμε τον κόμβο "Not Charged" με αυτόν, με ετικέττα συνδέσμου "False".


Ανοίγουμε την Αλυσίδα Κανόνων της Ρίζας (Root Rule Chain), προσθέτουμε μία Αλυσίδα Κανόνων (rule chain), με όνομα "Dimiourgia kai Ekka8arrisi Synagermwn", στην "Αλυσίδα Κανόνων" πληκτρολογούμε "Dimiourgia kai Ekka8arrisi Synagermwn" και πατάμε "Προσθήκη". Συνδέουμε αυτή την Αλυσίδα Κανόνων με τον κόμβο "Save Time Series" με σύνδεσμο με ετικέττα "Success".


Στην επόμενη εικόνα, βλέπουμε τους τρεις (3) μηχανισμούς Ειδοποίησης (alarms) που διαμορφώνονται από τις αντίστοιχες Αλυσίδες Κανόνων.


![Εικόνα Β27](./Εικόνες/Β1/27.%20Τρεις%20μηχανισμοί%20ειδοποίησης.jpg)


Επίσης, στην επόμενη εικόνα, φαίνεται η Ρίζα Αλυσίδας Κανόνων (Root Rule Chain A (Ρίζα))


![Εικόνα Β28](./Εικόνες/Β1/28.%20Ρίζα%20Αλυσίδα%20Κανόνων.jpg)


**2.**

**ΣΗΜΕΙΩΣΗ**
Επειδή οι δύο Μηχανισμοί Ειδοποίησης (alarms) δημιουργήθηκαν, αφού πρώτα εκπονήθηκε αυτό το σκέλος της Εργασίας, γι'αυτό στις επόμενες Εικόνες φαίνεται ότι στην Ρίζα Αλυσίδας Κανόνων είναι διασυνδεδεμένη μόνο μία Αλυσίδα Κανόνων.
...
Επιλέγουμε τον κόμβο "Temperature Validation" για επεξεργασία (ως script υπάρχει το "return msg.temperature > 20;") και επιλέγουμε το πλήκτρο "Test filter function" (βλ. Εικόνα Β23)


![Εικόνα Β23](./Εικόνες/Β1/22.%20Προσθήκη%20κανόνα%20κόμβου%20create%20alarm%20δ'.jpg)

Εικόνα Β23

Θέτουμε μία επιτρεπτή τιμή (22.4) και πατάμε "Τεστ". Στο χωρίο "Απόδοση" η εμφανιζόμενη τιμή είναι "true".
Αν θέσουμε μία τιμή εκτός ορίου (π.χ. 12.4) και πατήσουμε "Τεστ", στο χωρίο "Απόδοση" η εμφανιζόμενη τιμή θα είναι "false" (βλ. Εικόνες Β24 & Β25)


![Εικόνα Β24](./Εικόνες/Β1/24.%20Επαλήθευση%20εισερχόμενης%20τηλεμετρίας%20α'-2.jpg)


Εικόνα Β24


![Εικόνα Β25](./Εικόνες/Β1/25.%20Επαλήθευση%20εισερχόμενης%20τηλεμετρίας%20α'-3.jpg)


Εικόνα Β25

Έτσι, η Ρίζα Αλυσίδας Κανόνων, θα φαίνεται όπως στην Εικόνα Β25


![Εικόνα Β26](./Εικόνες/Β1/26.%20Επαλήθευση%20εισερχόμενης%20τηλεμετρίας%20α'-4.jpg)
