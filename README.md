...
Θα πρέπει να σημειώσουμε ότι στον κόμβο "Create Inactivity Alarm", θα πρέπει να επιλέξουμε το πεδίο "Propagate alarm to related entities", όπως φαίνεται στην Εικόνα Β15).
