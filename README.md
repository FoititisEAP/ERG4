...
Κατά γνωστά, από την κεντρική καρτέλλα "Κανόνες", επιλέγουμε "Προσθήκη Αλυσίδας Κανόνων" -> "Δημιουργία Νέας Αλυσίδας Κανόνων". Στη συνέχεια δίνουμε ως όνομα το "Create & Clear Alarms" και επιλέγουμε "Προσθήκη".
