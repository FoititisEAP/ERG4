...
ε) Πληκτρολογούμε στη γραμμή εντολών συστήματος (command prompt) για κάθε θερμόμετρο που θα συνδέσουμε, την εντολή:
